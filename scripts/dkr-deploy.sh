...
# Step 2: Tag
set -x
docker tag ${IMAGE_ID} docker.pkg.github.com/${GH_USERNAME}/docker-packaging/${IMAGE_NAME}:${VERSION}
set +x
# Step 3: Publish
set -x
docker push docker.pkg.github.com/${GH_USERNAME}/docker-packaging/${IMAGE_NAME}:${VERSION}
set +x
